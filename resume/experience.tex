    ...
    {Jul 2020 - Mar 2021} % Date(s)
    {
      \begin{cvitems} % Description(s) of tasks/responsibilities
        \item {Built a full-stack system for an AI service,
              ...
              and incudes a backend system to manages the AI service.}
      \end{cvitems}
    }
...
%---------------------------------------------------------
  \cventry
    ...
    {
      \begin{cvitems} % Description(s) of tasks/responsibilities
        \item {Developed the module that enables users dowonloading files directly to Dropbox on Puffin browser,
