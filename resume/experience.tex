    ...
    {Sep 2022 - Present} % Date(s)
    {
      \begin{cvitems} % Description(s) of tasks/responsibilities
        \item {
          ...
          Implemented diverse  \textbf{industrial robotic protocols} via PcapPlusPlus(libpcap) for Mujin device detection.
        }
        \item {Heavy contributor for the  \textbf{PcapPlusPlus} open-source project.}
